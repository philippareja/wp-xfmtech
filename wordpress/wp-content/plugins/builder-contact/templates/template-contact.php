...
if (TFCache::start_cache($mod_name, self::$post_id, array('ID' => $module_ID))):
    ...
    $field_subject_require =  'yes' === $fields_args['field_subject_require'];
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" class="builder-contact" id="<?php echo $module_ID; ?>-form" method="post">
            ...
            <div class="builder-contact-fields">
                <div class="builder-contact-field builder-contact-field-name builder-contact-text-field" data-order="<?php echo isset($field_order['field_name_label'])?$field_order['field_name_label']:'' ?>">
                    <label class="control-label" for="<?php echo $module_ID; ?>-contact-name"><span class="tb-label-span"><?php if ($fields_args['field_name_label'] !== ''): ?><?php echo $fields_args['field_name_label']; ?> </span><span class="required">*</span><?php endif; ?></label>
                ...
                <div class="builder-contact-field builder-contact-field-email builder-contact-text-field" data-order="<?php echo isset($field_order['field_email_label'])?$field_order['field_email_label']:'' ?>">
                    <label class="control-label" for="<?php echo $module_ID; ?>-contact-email"><span class="tb-label-span"><?php if ($fields_args['field_email_label'] !== ''): ?><?php echo $fields_args['field_email_label']; ?> </span><span class="required">*</span><?php endif; ?></label>
                    <div class="control-input">
                ...
                <?php if ($field_subject_active) : ?>
                    <div class="builder-contact-field builder-contact-field-subject builder-contact-text-field" data-order="<?php echo isset($field_order['field_subject_label'])?$field_order['field_subject_label']:'' ?>">
                        <label class="control-label" for="<?php echo $module_ID; ?>-contact-subject"><span class="tb-label-span"><?php echo $fields_args['field_subject_label']; ?> <?php if( $field_subject_require ){ ?></span><span class="required">*</span><?php } ?></label>
                        <div class="control-input">
                ...
                <div class="builder-contact-field builder-contact-field-message builder-contact-textarea-field" data-order="<?php echo isset($field_order['field_message_label'])?$field_order['field_message_label']:'' ?>">
                    <label class="control-label" for="<?php echo $module_ID; ?>-contact-message"><span class="tb-label-span"><?php if ($fields_args['field_message_label'] !== ''): ?><?php echo $fields_args['field_message_label']; ?> </span><span class="required">*</span><?php endif; ?></label>
                    <div class="control-input">
                        ...
                        <div class="builder-contact-field builder-contact-field-extra builder-contact-<?php echo $field['type']; ?>-field" data-order="<?php echo isset($field_order[$field['label']])?$field_order[$field['label']]:'' ?>">
                            ...
                            <div class="control-input">
                                <?php if( 'textarea' === $field['type'] ): ?>
                                    <textarea name="field_extra_<?php echo $field_index; ?>" id="field_extra_<?php echo $field_index; ?>" placeholder="<?php echo $field['value']; ?>" rows="8" cols="45" class="form-control" <?php echo $required?  'required' : '' ?> ></textarea>
                                <?php elseif( 'text' === $field['type'] ): ?>
                                    <input type="text" name="field_extra_<?php echo $field_index; ?>" id="field_extra_<?php echo $field_index; ?>" placeholder="<?php echo $field['value']; ?>" class="form-control" <?php echo $required?  'required' : '' ?> />
                                ...
                                <?php elseif( 'checkbox' === $field['type'] ): ?>
                                    <?php foreach( $field['value'] as $value ): ?>
                                        <label>
                                            <input type="checkbox" name="field_extra_<?php echo $field_index; ?>[]" value="<?php echo esc_attr($value); ?>" class="form-control" <?php echo $required?  'required' : '' ?> /> <?php echo $value; ?>
                                        </label>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
