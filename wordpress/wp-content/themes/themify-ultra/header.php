			...
			<?php themify_header_before(); // hook ?>
                        <?php if($show_menu_navigation):?>
                            ...
                            <div class="header-nav">
	                            ...
	                            <nav id="main-nav-wrap-icons" class="main-nav" itemscope="itemscope" itemtype="https://schema.org/SiteNavigationElement">
									<?php if ( $show_menu_navigation ) : ?>
				...
				<?php if ( $show_mobile_menu ) : ?>
					<div id="mobile-menu" class="sidemenu sidemenu-off">
						...
						<div class="navbar-wrapper clearfix">
							...
							<nav id="main-nav-wrap"   class="main-nav" itemscope="itemscope" itemtype="https://schema.org/SiteNavigationElement">
								<?php if ( $show_menu_navigation ) : ?>
									<?php themify_menu_nav( array( 'walker' => new Themify_Mega_Menu_Walker ) ); ?>
									<!-- /#main-nav -->
